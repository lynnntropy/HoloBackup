...
class Window(QtGui.QWidget):
	...
	def initUI(self):
		...
		warning2.setGeometry(20, 84, 300, 14)
		warning2.setText("<font color='red'>Device backups are not interchangeable.<font>")
		warning2.show()
		
		warning3 = QtGui.QLabel(self)
		warning3.setGeometry(25, 98, 300, 14)
